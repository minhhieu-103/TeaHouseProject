...
<div id="container">
    ...
    <div id="right">
        ...
        <form method="post" action="{{URL::to('/register/customer')}}">

            <input type="text" name="name" value="{{old('name')}}" class="client-info" required>
            <label for="name">Name:</label>
            <input type="text" name="address" value="{{old('name')}}" class="client-info" required>
            <label for="Address">Address:</label>
            <input type="text" name="phone" class="client-info" required>
            <label for="phone">Phone:</label>
            <input type="text" name="email" class="client-info" required>
